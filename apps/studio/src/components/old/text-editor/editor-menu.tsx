import { BoldIcon, ItalicIcon, LettercaseIcon, LinkIcon, LowercaseIcon, StrikethroughtIcon, UnderlineIcon, UppercaseIcon } from "../icons";
  ...
  return (
    <div className="inline-flex items-center">
      ...
      <span className={ (enabledKeys.has('UNDERLINE') ? activeClass : 'hover:bg-gray-100') + " inline-flex cursor-pointer p-1 rounded-sm mr-2"} onClick={onSetStyle('UNDERLINE')}>
        <UnderlineIcon color="black" size={4}/>
      </span>
