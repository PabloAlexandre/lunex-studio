import { createBasicCommand, createBasicItem, isViewActive } from "@editor/commands";
import { ElementType, useEffect, useRef, useState } from "react";
import { ClassicPreset } from "rete";
import { Drag } from "rete-react-render-plugin";
import { StyledSocket } from "../styles";
import { NodeItem, RegisterStorage } from "@editor/register";
...
> {
  ...
  constructor(node: NodeItem, change?: () => void) {
    super(node.name);
...
export function createBaseNode(itemInfo: BaseNodeItemCommand, node: NodeItem | NodeItem[], category = "Controller Primitives") {
