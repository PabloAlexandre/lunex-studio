...
function Page() {
  ...
  return (
    <div className="flex items-center justify-center flex w-full h-screen dark:bg-gray-700">
      ...
      <button onClick={createWindow({ icon: "PageIcon", isEditable: true, canClose: false, title: "Viewport", type: 'viewport' })} className="bg-emerald-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded mr-4">Viewport</button>
